...
class _CharacteristicTileState extends State<CharacteristicTile> {
  ...
  Future onWritePressed() async {
    try {
      ...
      await c.write([117, 114, 108], withoutResponse: c.properties.writeWithoutResponse);
  ...
  Widget buildSubscribeButton(BuildContext context) {
    ...
    print("=======buildSubscribeButton isNotifying: $isNotifying");
    if (!isNotifying) {
      widget.characteristic.setNotifyValue(true); //默认打开接收数据
      isNotifying = true;
    }
    return TextButton(
